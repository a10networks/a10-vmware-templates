...
def configure_ethernets(base_url, authorization_token, controller_addresses):
    """
    ...
    while ethernet_number <3:
        if ethernet_number == 1:
            address_list = controller_addresses['ethernet1-addresses']
            print(address_list)
        else:
            address_list = controller_addresses['ethernet2-addresses']
        # AXAPI ethernets Url
...
master_controller = slb_param_data["parameters"]["master-controller-address-list"]
member_controller = slb_param_data["parameters"]["member-controller-address-list"]
site1_device = slb_param_data["parameters"]["site1-address-list-reg1"]
site2_device = slb_param_data["parameters"]["site2-address-list-reg1"]
site3_device = slb_param_data["parameters"]["site1-address-list-reg2"]
site4_device = slb_param_data["parameters"]["site2-address-list-reg2"]
...
for ith in range(len(site_list)):
    ...
    if ith == 0:
        configure_ethernets(base_url, authorization_token, site1_device)
    elif ith == 1:
        configure_ethernets(base_url, authorization_token, site2_device)
    elif ith == 2:
        configure_ethernets(base_url, authorization_token, site3_device)
    else:
        configure_ethernets(base_url, authorization_token, site4_device)
...
for ith in range(len(vm_controller_ips)):
    ...
    if ith == 0:
        configure_ethernets(base_url, authorization_token, master_controller)
    else:
        configure_ethernets(base_url, authorization_token, member_controller)
